            ...
            <div className="flex items-center space-x-3 mt-9">
              <div>
                <Link
                  to="#"
                  title=""
                  className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-fdivl w-7 h-7 hover:bg-blue-600 focus:bg-blue-600"
                >
                  <svg
                    className="w-4 h-4"
